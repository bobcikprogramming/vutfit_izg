...
#all necessary matrix or vector operations can be found at https://docs.blender.org/api/current/mathutils.html
    ...
    def createView():
        ...
        Z = (centerPosition - eyePosition) @ mathutils.Matrix.Rotation(math.radians(167.0), 4, 'Z') 
        Z.normalize()
    ...
    def createTransformation(object, view):
        ...
        #the desired transformation will be described at the beginning of the exercise (ask the teacher if not)
        #######################
        transformation = view @ mathutils.Matrix.Translation((0, 0, -objectNumber)) @ mathutils.Matrix.Rotation(radians(90.0), 4, 'X')
        #######################
    ...
    def applyTransformation(transformation, object):
        for vertex in object.data.vertices:
            ...
            #######################
            vertex.co = transformation @ mathutils.Vector(vertex.co)
            #######################
